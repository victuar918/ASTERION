# ASTERION 전체 시스템 현황 및 진행 로드맵 v3
> 최종 업데이트: 2026-05-17  
> 이 파일이 유일한 정본 문서입니다.
...
**프롬프트 캐싱**
- Claude: cache_control: ephemeral (system + 도구 목록)
- Gemini: Implicit Caching (Google 자동)
- GPT: Automatic Prefix Caching (OpenAI 자동)
...
**[A] GCP Agent Registry protocolBinding 유효값 미확인**
- HTTP_JSON 오류 확인됨, MCP 전용 값 불확실
- gcloud CLI 직접 등록으로 우회 가능
